...
def prepare_tokenizer(args):
    if args.encoder_type == 'bert':
        ...
        tokenizer = BertTokenizer.from_pretrained(args.plm_path, do_lower_case=False, cache_dir='/home/wjy/newdisk/project/')
...
class LTRRaceDataset(BaseDataset):
    def __init__(self, args, split='train'):
        ...
        self.data_folder = f'/home/wjy/newdisk/project/MCQ/pre-rank/data/{args.dataset}'
        self.process()
